...
<head>
	...
	<link rel="stylesheet" href="../admin_ui/lib/zTree/v3/css/zTreeStyle/zTreeStyle.css" type="text/css">
</head>
<body class="pos-r">
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="../admin_ui/lib/zTree/v3/js/jquery.ztree.all-3.5.min.js"></script>
<script type="text/javascript" src="../admin_ui/lib/My97DatePicker/4.8/WdatePicker.js"></script> 
<script type="text/javascript" src="../admin_ui/lib/datatables/1.10.0/jquery.dataTables.min.js"></script> 
<script type="text/javascript" src="../admin_ui/lib/laypage/1.2/laypage.js"></script>
...
var zNodes =[
	{ id:1, pId:0, name:"面食", open:true},
	{ id:1, pId:0, name:"汤粥", open:true},
	{ id:1, pId:0, name:"热菜", open:true},
	{ id:1, pId:0, name:"凉菜", open:true},
	{ id:1, pId:0, name:"米饭套餐", open:true},
	{ id:1, pId:0, name:"馅饼", open:true},
];
